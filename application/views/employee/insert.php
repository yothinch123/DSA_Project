<div class="container-fluid" id="container-wrapper" style="margin-top: 90px;" ng-app="insertEmployeeApp"
    ng-controller="insertEmployeeCtrl">
    <div class="row mb-3">
        <div class="col-xl-12 col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between"
                    style="background-color: #3490de;">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ssn" ng-model="ssn"
                                                autocomplete="off">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="fname" ng-model="fname"
                                                autocomplete="off">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="lname" ng-model="lname"
                                                autocomplete="off">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="password"
                                                ng-model="password" autocomplete="off">
        ...
        $http.post("<?php echo base_url("EmployeeController/insertEmployee"); ?>", {
            ...
            if (response) {
                Swal.fire({
                    ...
                    location.href =
                        '<?php echo base_url("BaseController/view_employee"); ?>';
                })
            } else {
                Swal.fire({
